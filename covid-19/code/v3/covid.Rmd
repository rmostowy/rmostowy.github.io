...
wojewodztwa <- unique(covid19.xlsx.wojew$...1)
...
from <- which(covid19.xlsx.wojew$...1 == "Województwo")[1]
to <- which(covid19.xlsx.wojew$...1 == "Polska")[1]
covid19.xlsx.wojew <- covid19.xlsx.wojew[from:(to-1),]

wojewodztwa.dates <- covid19.xlsx.wojew[which(covid19.xlsx.wojew$...1 == "Województwo"),-1]
...
wojewodztwa.incidence <- sapply(1:n, function(wojewodztwo.index){
  ...
  this.wojewodztwo.row <- which(covid19.xlsx.wojew$...1 == this.wojewodztwo)
...
# Szacunek efektywnego współczynnika reprodukcji R dla COVID-19 w Polsce
### **Rafał J. Mostowy**
